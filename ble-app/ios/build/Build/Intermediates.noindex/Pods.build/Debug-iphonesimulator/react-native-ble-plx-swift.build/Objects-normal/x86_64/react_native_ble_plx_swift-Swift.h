...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="react_native_ble_plx_swift",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC26react_native_ble_plx_swift16BleClientManager")
...
SWIFT_PROTOCOL("_TtP26react_native_ble_plx_swift24BleClientManagerDelegate_")
@protocol BleClientManagerDelegate
- (void)dispatchEvent:(NSString * _Nonnull)name value:(id _Nonnull)value;
@end


SWIFT_CLASS("_TtC26react_native_ble_plx_swift8BleEvent")
